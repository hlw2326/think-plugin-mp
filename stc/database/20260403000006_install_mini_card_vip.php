...
class InstallMiniCardVip extends Migrator
{
    /**
     * 创建会员卡密表
     */
    ...
    {
        $table = $this->table('plugin_mini_card_vip', [
            'engine' => 'InnoDB',
        ...
        PhinxExtend::upgrade($table, [
            ...
            ['vip_days', 'integer', ['limit' => 11, 'default' => 0, 'null' => true, 'comment' => '会员天数']],
    ...
    {
        $this->table('plugin_mini_card_vip')->drop();
    }
}
